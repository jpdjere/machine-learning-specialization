...
![](./img/2024-03-27-16-09-21.png)

Finally the reward function for the Lunar Lander:

![](./img/2024-03-27-16-10-21.png)
...
Despite all the research momentum and excitement behind reinforcement learning though, there is a bit or maybe sometimes a lot of hype around it. So let's get a practical sense of where reinforcement learning is today in terms of its utility for applications:

First, **many of the research publications have been on simulated environments**. Having worked in both simulations and on real robots myself, I can say that it's much easier to get a reinforcement learning album to work in a simulation or in a section game than in a real robot. So a lot of developers have commented that even after they got it to work in simulation, it turned out to be surprisingly challenging to get something to work in the real world or the real robot. And so if we apply these algorithms to a real application, this is one limitation that I hope we pay attention to to make sure what we do does work on the real application.

![](./img/2024-03-31-23-38-30.png)
