...
This particular cost function has the nice property that it is convex (has a single global minimum), which allows us to implement gradient descent over it.
