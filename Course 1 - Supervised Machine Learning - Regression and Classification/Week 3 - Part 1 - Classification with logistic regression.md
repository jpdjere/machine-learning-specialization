...
![](2024-01-02-09-40-50.png)

![](2024-01-02-09-41-12.png)
...
What we want the learning algorithm to predict is if the value of $y$ is going to be `0` or `1`. One thing you might do is **set a threshold above which you predict that $y$ is `1`, and below is `0`**:

![](2024-01-02-09-45-48.png)
